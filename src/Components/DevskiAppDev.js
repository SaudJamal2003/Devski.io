...
//                         <div className={DevskiWebDevCss.ProcessBoxHeading}>
//                             <h1>Strategy</h1>
//                             <p>We develop a strategy that outlines the design approach, user experience, and key features of the project.</p>
//                         </div>
//                     </div>
...
//                         <div className={DevskiWebDevCss.ProcessBoxHeading}>
//                             <h1>Design</h1>
//                             <p>We work closely with our clients to get feedback and iterate on the design until it meets their needs and vision.</p>
//                         </div>
//                     </div>
...
//                         <div className={DevskiWebDevCss.ProcessBoxHeading}>
//                             <h1>Development</h1>
//                             <p>Once the design is finalized, our development team takes over to build the final product.</p>
//                         </div>
//                     </div>
//                 </div>
//             </div>

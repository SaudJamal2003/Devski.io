                ...
                <div className={ContactusCss.EveryFooterDiv}>
                    ...
                    <div className={ContactusCss.AllColumn}>
                        ...
                        <div className={ContactusCss.MiddleColumn}>
                            ...
                            <button className={ContactusCss.CardButton}>Discuss Your Project <span> </span> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="12" viewBox="0 0 10 12" fill="none">
                    ...
                    <div className={ContactusCss.ThinLine}>
                        ...
                        <div className={ContactusCss.SocialMedia}>
                            <img src = {behance} className={ContactusCss.behance} alt = "behance"/>
                            <img src = {Insta} className={ContactusCss.Insta} alt = "Insta"/>
                            <img src = {linkedin_logo} className={ContactusCss.linkedin} alt = "linkedin"/>
                        </div>
                    </div>
                </div>
